...
import { UpdateStudentPersonalDetailsStatusService, updateStudentScoreStatusService } from "../ApiService";
import { CustomSelectInput, InputWithIcon } from "../../../Components/CustomComponents/InputWithIcon";
import { PrimaryButton } from "../../../Components/CustomComponents/ButtonUi";
import { message } from "antd";

const ScoreStatusChange = ({
  userName,
  setOpen,
  getDetailApi,
  dataremarks,
  ...
  const changeStatusApi = () => {
    ...
    updateStudentScoreStatusService(userName, payload)
...
export default ScoreStatusChange;
