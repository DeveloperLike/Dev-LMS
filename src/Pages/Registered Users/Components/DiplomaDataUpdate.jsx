...
import { UpdateStudentDiplomaDetailsStatusService } from "../ApiService";

const DiplomaDataUpdate = ({
  userName,
  setEditOpen,
  getProfileDetailApi,
  dataremarks,
  ...
  const addCourseApi = () => {
    ...
    UpdateStudentDiplomaDetailsStatusService(userName, payload)
...
export default DiplomaDataUpdate;
