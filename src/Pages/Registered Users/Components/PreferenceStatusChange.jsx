...
import { UpdateStudentPersonalDetailsStatusService, updateStudentPreferenceStatusService } from "../ApiService";
import { CustomSelectInput, InputWithIcon } from "../../../Components/CustomComponents/InputWithIcon";
import { PrimaryButton } from "../../../Components/CustomComponents/ButtonUi";
import { message } from "antd";

const PreferenceStatusChange = ({
  userName,
  setOpen,
  getDetailApi,
  dataremarks,
  ...
  const changeStatusApi = () => {
    ...
    updateStudentPreferenceStatusService(userName, payload)
...
export default PreferenceStatusChange;
