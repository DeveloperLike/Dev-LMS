...
import { updateStudentPostGraducationDetailsStatusService } from "../ApiService";


const PostGraduationUpdate = ({
  userName,
  setEditOpen,
  getProfileDetailApi,
  dataremarks,
  ...
  const addCourseApi = () => {
    ...
    updateStudentPostGraducationDetailsStatusService(userName, payload)
...
export default PostGraduationUpdate;
