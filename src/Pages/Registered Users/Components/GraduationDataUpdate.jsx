...
const GraduationDataUpdate = ({
  ...
  const addCourseApi = () => {
    ...
    updateStudentGraducationDetailsStatusService(userName, payload)
...
export default GraduationDataUpdate;
