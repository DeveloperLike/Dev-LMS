...
import { message, DatePicker, Drawer, Modal } from "antd";
...
import IntermediateDataUpdate from "./IntermediateDataUpdate";
dayjs.extend(customParseFormat);

const fields = [
  {
    key: "twelth_completed_on",
    label: (
      <>
        12<sup>th</sup>/Intermediate Completed On
      </>
    ),
    type: "date",
  },
  {
    key: "twelth_school_college",
    label: (
      <>
        12<sup>th</sup>/Intermediate School/College
      </>
    ),
  },
  {
    key: "twelth_board_university",
    label: (
      <>
        12<sup>th</sup>/Intermediate Board/University
      </>
    ),
  },
  {
    key: "twelth_marks_cgpa",
    label: (
      <>
        12<sup>th</sup>/Intermediate Marks/CGPA
      </>
    ),
    type: "number",
  },
...
export const Intermediate = ({
  ...
  const getIntermediateDetailApi = () => {
    getStudentIntermediateDetailsService(userName).then((response) => {
  ...
  const editIntermediateDetailApi = () => {
  ...
  return (
    <>
      ...
      <Drawer
        ...
        open={editOpen}
      >
        <IntermediateDataUpdate
          userName={userName}
          setEditOpen={setEditOpen}
          getProfileDetailApi={getIntermediateDetailApi}
