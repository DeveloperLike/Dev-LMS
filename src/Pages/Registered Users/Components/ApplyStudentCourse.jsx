...
import { postStudentCourseApplicationService } from "../ApiService";
import {
  CustomDatePicker,
  CustomSelectInput,
...
export const ApplyStudentCourse = ({ userName, selectedCourse, setOpen, getListApi}) => {
  ...
  const addUserMappedDocumentApi = () => {
    ...
    postStudentCourseApplicationService(payload, userName)
  ...
  const course_application_status_choices = [
    ...
    { value: "filled_&_pending_for_review", label: "Filled & Pending For Review (1st Step)" },
    { value: "2nd_review_pending", label: "2nd Review Pending" },
    { value: "2nd_review_pending_1st_step", label: "2nd Review Pending (1st Step)" },
    { value: "filled_&pending_for_review", label: "Filled & Pending For Review" },
    { value: "reviewed&document_pending", label: "Reviewed & Document Pending" },
  ...
  const offer_letter_status_choices = [
    ...
    { value: "unconditional_offer_received", label: "Unconditional Offer Received" },
    { value: "conditional_offer_received", label: "Conditional Offer Received" },
    { value: "university_contract_received", label: "University Contract Received" },
  ];
  ...
  const admission_status_choices = [
    ...
    { value: "admission_not_accepted_by_student", label: "Admission Not Accepted By Student" },
    { value: "admission_accepted_by_student", label: "Admission Accepted By Student" },
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <label>Deadline<sup className="text-red-500">*</sup></label>
        <CustomDatePicker
          name={"deadline"}
      ...
      <div className="flex flex-col gap-1">
        <label>First Step Deadline<sup className="text-red-500">*</sup></label>
        <CustomDatePicker
      ...
      <div className="flex flex-col gap-1">
        <label>Application Fee Status<sup className="text-red-500">*</sup></label>
        <CustomSelectInput
      ...
      <div className="flex flex-col gap-1">
        <label>Application Start Date<sup className="text-red-500">*</sup></label>
        <CustomDatePicker
      ...
      <div className="flex flex-col gap-1">
        <label>Acceptance Deadline<sup className="text-red-500">*</sup></label>
        <CustomDatePicker
      ...
      <div className="flex flex-col gap-1">
        <label>Offer Received On<sup className="text-red-500">*</sup></label>
        <CustomDatePicker
      ...
      <div className="flex flex-col gap-1">
        <label>Late Arrival Date<sup className="text-red-500">*</sup></label>
        <CustomDatePicker
      ...
      <div className="flex flex-col gap-1">
        <label>Enrollment Date<sup className="text-red-500">*</sup></label>
        <CustomDatePicker
      ...
      <div className="flex flex-col gap-1">
        <label>Tuition Fee Status<sup className="text-red-500">*</sup></label>
        <CustomSelectInput
      ...
      <div className="flex flex-col gap-1">
        <label>Course Start Date<sup className="text-red-500">*</sup></label>
        <CustomDatePicker
      ...
      <div className="flex flex-col gap-1">
        <label>Application Status<sup className="text-red-500">*</sup></label>
        <CustomSelectInput
      ...
      <div className="flex flex-col gap-1">
        <label>Application Intake<sup className="text-red-500">*</sup></label>
        <CustomSelectInput
