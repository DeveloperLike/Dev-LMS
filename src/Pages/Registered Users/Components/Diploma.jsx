...
import DiplomaDataUpdate from "./DiplomaDataUpdate";
...
export const Diploma = ({ userName, getIsApprovedApi, modulePermission }) => {
  ...
  const getDiplomaDetailApi = () => {
    getStudentDiplomaDetailsService(userName).then((response) => {
  ...
  const editDiplomaDetailApi = () => {
    ...
    editDiplomaDetailService(dataToSubmit, userName)
      .then((response) => {
