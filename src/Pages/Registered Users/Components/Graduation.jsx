...
import GraduationDataUpdate from "./GraduationDataUpdate";
...
export const Graduation = ({
  ...
  const getGraduationDetailApi = () => {
    getStudentGraducationDetailsService(userName).then((response) => {
  ...
  const editGraduationDetailApi = () => {
    ...
    editGraduationDetailService(dataToSubmit, userName)
      .then((response) => {
