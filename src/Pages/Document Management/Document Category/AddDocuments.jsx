...
import { postMappedDocumentService } from "./ApiService";
...
const AddDocuments = ({ getMappedDocumentsApi, setOpen, id }) => {
  ...
  const addMappedDocumentApi = () => {
    ...
    postMappedDocumentService(id, payload)
