...
const EditDocumentCategory = ({ id, getDocumentCategoryApi, setEditOpen }) => {
  ...
  const editDocumentCategoryApi = () => {
    ...
    editDocumentCategoryService(payload, id)
  ...
  useEffect(() => {
    getDocumentCategoryDetailService(id).then(function (response) {
