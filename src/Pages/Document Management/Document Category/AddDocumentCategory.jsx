...
import { addDocumentCategoryService } from "./ApiService";

const AddDocumentCategory = ({ getDocumentCategoryApi, setOpen, id }) => {
  ...
  const addDocumentCategoryApi = () => {
    ...
    addDocumentCategoryService(payload, id)
