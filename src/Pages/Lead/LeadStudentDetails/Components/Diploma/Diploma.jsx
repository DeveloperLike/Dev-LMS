...
import { editLeadDiplomaDetailService, getLeadStudentDiplomaDetailsService } from "../../../ApiService";
dayjs.extend(customParseFormat);

const fields = [
  { key: "diploma_completed_on", label: "Diploma Completed On", type: "date" },
  { key: "diploma_school_college", label: "Diploma School/College" },
  { key: "diploma_marks_cgpa", label: "Diploma Marks/CGPA", type: "number" },
  {
    key: "diploma_professor_email",
    label: "Diploma Professor Email",
    type: "email",
  },
];
export const LeadDiploma = ({ userName, getIsApprovedApi, modulePermission }) => {
  ...
  const getDiplomaDetailApi = () => {
    getLeadStudentDiplomaDetailsService(userName).then((response) => {
  ...
  const handleInputChange = (e, field) => {
    ...
    if (field === "diploma_completed_on" && e instanceof dayjs) {
      console.log("diploma_completed_on value on change:", value);
    }
  ...
  const editDiplomaDetailApi = () => {
    ...
    editLeadDiplomaDetailService(dataToSubmit, userName)
      .then((response) => {
    ...
    <>
      ...
      >
        <DiplomaDataUpdate
          ...
          getProfileDetailApi={getDiplomaDetailApi}
