...
import { editLeadPostGraduationDetailService, getLeadStudentPostGraducationDetailsService } from "../../../ApiService";
...
export const LeadPostGraduation = ({
  userName,
  getIsApprovedApi,
  modulePermission,
}) => {
  ...
  const getPostGraduationDetailApi = () => {
    getLeadStudentPostGraducationDetailsService(userName).then((response) => {
  ...
  const editPostGraduationDetailApi = () => {
    ...
    editLeadPostGraduationDetailService(dataToSubmit, userName)
      .then((response) => {
