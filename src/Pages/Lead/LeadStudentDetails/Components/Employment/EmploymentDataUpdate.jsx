...
const LeadEmploymentDataUpdate = ({
  ...
  const addCourseApi = () => {
    ...
    // UpdateStudentEmploymentStatusService(userName,selectedData, payload)
...
export default LeadEmploymentDataUpdate;
