...
import { CustomDatePicker, CustomSelectInput, InputWithIcon } from "../../../../../Components/CustomComponents/InputWithIcon";
import { PrimaryButton } from "../../../../../Components/CustomComponents/ButtonUi";
import { addLeadEmploymentService, editLeadEmploymentDetailService, getLeadEmploymentDetailService } from "../../../ApiService";
...
const LeadEmployment = ({ userName }) => {
  ...
  const getListApi = () => {
    getLeadEmploymentDetailService(userName).then((response) => {
...
export const AddEmployment = ({ getListApi, setOpen, userName }) => {
  ...
  const addEmploymentApi = () => {
    ...
    addLeadEmploymentService(dataToSubmit, userName)
      .then((response) => {
...
export const EditEmployment = ({ id, getListApi, setEditOpen, userName }) => {
  ...
  const getEmploymentApi = () => {
    getLeadEmploymentDetailService(userName, id).then((response) => {
  ...
  const editEmploymentApi = () => {
    ...
    editLeadEmploymentDetailService(dataToSubmit, userName, id)
      .then((response) => {
        if (response.data.success === "1") {
          getListApi();
          setEditOpen(false);
