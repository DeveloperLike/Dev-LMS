...
import { editLeadGraduationDetailService, getLeadStudentGraducationDetailsService } from "../../../ApiService";
dayjs.extend(customParseFormat);

const fields = [
  {
    key: "graduation_completed_on",
    label: "Graduation Completed On",
    type: "date",
  },
  { key: "graduation_board_university", label: "Graduation Board/University" },
  {
    key: "graduation_marks_cgpa",
    label: "Graduation Marks/CGPA",
    type: "number",
  },
  {
    key: "graduation_professor_email",
    label: "Graduation Professor Email",
    type: "email",
  },
];
export const LeadGraduation = ({
  userName,
  getIsApprovedApi,
  modulePermission,
}) => {
  ...
  const getGraduationDetailApi = () => {
    getLeadStudentGraducationDetailsService(userName).then((response) => {
  ...
  const editGraduationDetailApi = () => {
    ...
    editLeadGraduationDetailService(dataToSubmit, userName)
      .then((response) => {
        if (response.data.success === "1") {
          getGraduationDetailApi();
  ...
  return (
    <>
      ...
      {/* <Drawer
        ...
        open={editOpen}
      >
        <GraduationDataUpdate
          userName={userName}
          setEditOpen={setEditOpen}
          getProfileDetailApi={getGraduationDetailApi}
