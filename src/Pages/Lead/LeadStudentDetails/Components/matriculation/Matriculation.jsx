...
// import LeadMatriculationDataUpdate from "./MatriculationDataUpdate";
import { PrimaryButton } from "../../../../../Components/CustomComponents/ButtonUi";
import LoadSkeleton from "../../../../../Components/CustomComponents/Skeleton";
import { editLeadMatriculationDetailService, getLeadMatriculationDetailService } from "../../../ApiService";
...
export const LeadMatriculation = ({
  userName,
  getIsApprovedApi,
  modulePermission,
}) => {
  ...
  const getMatriculationDetailApi = () => {
    getLeadMatriculationDetailService(userName).then((response) => {
  ...
  const editMatriculationDetailApi = () => {
    ...
    editLeadMatriculationDetailService(dataToSubmit, userName)
      .then((response) => {
