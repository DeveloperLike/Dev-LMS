...
const EditCourseAdmissionApplication = ({
  id,
  getUniversityApi,
  setEditOpen,
}) => {
  ...
  const editCourseAdmissionApplicationApi = () => {
    const payload = {
    ...
    editCourseAdmissionApplicationService(payload, id)
  ...
  useEffect(() => {
    getCourseAdmissionApplicationDetailService(id).then(function (response) {
      const jsonResponse = response.data.data;
      setFormData({
        course: { value: jsonResponse.course, errors: [] },
        suggestedBy: { value: jsonResponse.suggestedBy, errors: [] },
        ApprovedByStudent: {
          value: jsonResponse.ApprovedByStudent,
          errors: [],
        },
        application_status: {
          value: jsonResponse.application_status,
          errors: [],
        },
        eligibility: { value: jsonResponse.eligibility, errors: [] },
      });
    });
  }, [id]);
  ...
  return (
    <>
      <form
        onSubmit={(e) => {
          e.preventDefault();
          editCourseAdmissionApplicationApi();
        }}
...
export default EditCourseAdmissionApplication;
