...
import { editCityListService, getCityDetailService } from "./ApiService";
import { message } from "antd";

const EditCity = ({ id, cityGetApi, setEditOpen }) => {
  ...
  const editCityApiService = () => {
    ...
    editCityListService(payload, id)
      .then((response) => {
      ...
      >
        <FormItem>
          <div className="flex flex-col gap-1">
            <label>
              City Name<sup className="text-red-500">*</sup>
            </label>
            <InputWithIcon
              name="name"
              required={true}
