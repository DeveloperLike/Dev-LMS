...
import { getAnalysisBySourceLeadService } from "./ApiService";
...
export const AnalysisByLeadSource = () => {
  const [failedLead, setFailedLead] = useState();
  const [leadSourceName, setLeadSourceName] = useState(null);
  const [leadSourceLead, setLeadSourceLead] = useState(null);
  ...
  const applyDateRange = () => {
    ...
    getAnalysisBySourceLeadService(payload).then((response) => {
      ...
      <div className="flex justify-between top-2 z-10">
        ...
        <div className="grid md:grid-cols-2 gap-3">
          ...
          <div>
            ...
            />
            <Button onClick={applyDateRange} type="primary" className="md:ml-2 mt-1 md:mt-0">
              Apply
            </Button>
          </div>
        </div>
