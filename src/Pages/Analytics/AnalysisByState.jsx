...
import { getAnalysisByStateService } from "./ApiService";
...
export const AnalysisByState = () => {
  const [failedLead, setFailedLead] = useState();
  const [stateName, setStateName] = useState(null);
  const [stateLead, setStateLead] = useState(null);
  ...
  const applyDateRange = () => {
    ...
    getAnalysisByStateService(payload).then((response) => {
