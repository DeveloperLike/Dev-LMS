...
import { getBranchMqlSqlQuery } from "../Queries/BranchPerfomanceQueries";
import { baseurl } from "../../../../lib/Constants";

dayjs.extend(utc);
dayjs.extend(timezone);

function BranchMqlSql({ startDate, endDate, counsellor, leadSource, sourceGroup, branch, role }) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const query = getBranchMqlSqlQuery({ whereClause });
            ...
            console.error("Branch MQL SQL Error:", err);
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="rounded-lg p-4 shadow-default bg-white dark:bg-boxdark">
            ...
            <Spin spinning={loading}>
                ...
                <Table
                    ...
                    locale={{
                        emptyText: <Empty description="No branch MQL SQL data available" />
                    }}
                    summary={() => (
                                    ...
                                    if (col.dataIndex === "total_lead") {
                                        return (
                                            <Table.Summary.Cell key={index} align="center">
                                                <strong>{totals.total_lead}</strong>
                                            </Table.Summary.Cell>
                                        );
                                    }
                                    ...
                                    if (col.dataIndex === "mql") {
                                        ...
                                        return (
                                            <Table.Summary.Cell key={index} align="center">
                                                ...
                                                <span className={`${d.color}`}>({d.percent}%)</span>
                                            </Table.Summary.Cell>
                                        );
                                    }
