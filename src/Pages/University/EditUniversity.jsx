...
const EditUniversity = ({ id, getUniversityApi, setEditOpen }) => {
  ...
  const editUniversityApi = () => {
    ...
    editUniversityService(payload, id)
  ...
  useEffect(() => {
    getUniversityDetailService(id).then(function (response) {
      const jsonResponse = response.data.data;
      setFormData({
        country: { value: jsonResponse.country, errors: [] },
        university_category: {
          value: jsonResponse.university_category,
          errors: [],
        },
        university_type: { value: jsonResponse.university_type, errors: [] },
        university_name: { value: jsonResponse.university_name, errors: [] },
        university_link: { value: jsonResponse.university_link, errors: [] },
        campus_location: { value: jsonResponse.campus_location, errors: [] },
      });
    });
  }, [id]);
