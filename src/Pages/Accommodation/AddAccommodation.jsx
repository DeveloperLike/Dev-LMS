...
import { addAccommodationService, getUniversityDropdownListService } from "./ApiService";

const AddAccommodation = ({ getListApi, setOpen }) => {
  ...
  const callCreateBranchApiService = () => {
    ...
    addAccommodationService(payload)
      .then((response) => {
