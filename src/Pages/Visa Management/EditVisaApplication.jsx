...
const EditVisaApplication = ({ id, getVisaApplicationApi, setEditOpen }) => {
  ...
  const editVisaApplicationApi = () => {
    ...
    editVisaApplicationService(payload, id)
  ...
  useEffect(() => {
    getVisaApplicationDetailService(id).then(function (response) {
      const jsonResponse = response.data.data;
      setFormData({
        application_id: { value: jsonResponse.application_id, errors: [] },
        visa_id: { value: jsonResponse.visa_id, errors: [] },
        vfs_region: { value: jsonResponse.vfs_region, errors: [] },
        ba_status: { value: jsonResponse.ba_status, errors: [] },
        ba_company: { value: jsonResponse.ba_company, errors: [] },
        visa_document_status: {
          value: jsonResponse.visa_document_status,
          errors: [],
        },
        visa_file_status: { value: jsonResponse.visa_file_status, errors: [] },
        visa_waitlisted_on: {
          value: jsonResponse.visa_waitlisted_on,
          errors: [],
        },
        visa_appointment_date: {
          value: jsonResponse.visa_appointment_date,
          errors: [],
        },
      });
    });
...
export default EditVisaApplication;
